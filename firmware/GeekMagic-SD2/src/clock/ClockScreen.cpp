...
static const ThemePalette THEMES[10] = {
    // 0 Green
    {0x6F4D, 0x1C63, LCD_WHITE, 0x1C63, 0x6F4D, 0x15E2, 0xB7F6, 0x0B41, 0x2264, 0x572A},
    // 1 Blue
    {0x6DBD, 0x1AD1, LCD_WHITE, 0x1AD1, 0x6DBD, 0x13D7, 0xB6FF, 0x0A0D, 0x21E9, 0x553C},
    // 2 Purple
    {0xAB5D, 0x50B1, LCD_WHITE, 0x50B1, 0xAB5D, 0x68B7, 0xDD9F, 0x384D, 0x3909, 0x9A9C},
    // 3 Cyan
    {0x6EFD, 0x1C11, LCD_WHITE, 0x1C11, 0x6EFD, 0x1597, 0xB7DF, 0x0B0D, 0x2249, 0x56DC},
    // 4 Amber
    {0xEDCD, 0x8B03, LCD_WHITE, 0x8B03, 0xEDCD, 0xBC02, 0xFF16, 0x6A41, 0x49E4, 0xE56A},
    // 5 Red
    {0xEB4D, 0x88A3, LCD_WHITE, 0x88A3, 0xEB4D, 0xB8A2, 0xFD96, 0x6841, 0x4904, 0xE28A},
    // 6 Pink
    {0xEB55, 0x88AA, LCD_WHITE, 0x88AA, 0xEB55, 0xB8AD, 0xFD9A, 0x6847, 0x4907, 0xE293},
    // 7 Orange
    {0xECCD, 0x8A03, LCD_WHITE, 0x8A03, 0xECCD, 0xBA82, 0xFE76, 0x6961, 0x4984, 0xE42A},
    // 8 White
    {0xD6BA, 0x8C52, LCD_WHITE, 0x8C52, 0xE7DD, 0xAD55, LCD_WHITE, 0x6318, 0x4208, 0xD6BA},
    // 9 Yellow
    {0xEEED, 0x8C03, LCD_WHITE, 0x8C03, 0xEEED, 0xBD82, 0xFFD6, 0x6B01, 0x4A44, 0xE6CA},
};
