...
// Classic 5x7 ASCII font (extracted from Adafruit/Arduino_GFX glcdfont, public domain).
// 95 chars (0x20..0x7E) x 5 columns. LSB = top row. FLASHDATA = .irom.text.
#ifndef GLCD5X7_H
#define GLCD5X7_H
#define FLASHDATA __attribute__((section(".irom.text")))
static const unsigned char GLCD5x7[] FLASHDATA = {
